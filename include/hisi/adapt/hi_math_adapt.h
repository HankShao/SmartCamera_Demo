...
/******************************************************************************
* hi_max2(x,y)              maximum of x and y
* hi_min2(x,y)              minimum of x and y
* hi_max3(x,y,z)            maximum of x, y and z
* hi_min3(x,y,z)            minimun of x, y and z
* median(x,y,z)             median of x,y,z
* mean2(x,y)                mean of x,y
******************************************************************************/
#define hi_max2(x,y)       ( (x)>(y) ? (x):(y) )
#define hi_min2(x,y)       ( (x)<(y) ? (x):(y) )
#define hi_max3(x,y,z)     ( (x)>(y) ? hi_max2(x,z) : hi_max2(y,z) )
#define hi_min3(x,y,z)     ( (x)<(y) ? hi_min2(x,z) : hi_min2(y,z) )
#define median(x,y,z)   (((x)+(y)+(z) - hi_max3(x,y,z)) - hi_min3(x,y,z) )
...
__inline static hi_void rgb2_yc_full(hi_u16 r, hi_u16 g, hi_u16 b, hi_u16 *py, hi_u16 *pcb, hi_u16 *pcr)
{
    ...
    *py = hi_max2(hi_min2(py_temp, 1023), 0);
    *pcb = hi_max2(hi_min2(pcb_temp, 1023), 0);
    *pcr = hi_max2(hi_min2(pcr_temp, 1023), 0);
}
...
__inline static hi_void rgb2_yc_full_8_bit(hi_u8 r, hi_u8 g, hi_u8 b, hi_u8 *py, hi_u8 *pcb, hi_u8 *pcr)
{
    ...
    *py = hi_max2(hi_min2(py_temp, 255), 0);
    *pcb = hi_max2(hi_min2(pcb_temp, 255), 0);
    *pcr = hi_max2(hi_min2(pcr_temp, 255), 0);
}
