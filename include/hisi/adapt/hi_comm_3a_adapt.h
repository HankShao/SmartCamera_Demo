 ...
 * Description: Function of hi_comm_3a_adapt.h
 * Author: ISP SW
 * Create: 2012/06/28
 */
...
typedef struct {
    ...
    hi_u32  histogram_mem_array[ISP_CHN_MAX_NUM][HIST_NUM];
} hi_isp_fe_ae_stat_1;
...
typedef struct {
    hi_u16  zone_avg[ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM];
} hi_isp_fe_ae_stat_3;

typedef struct {
    hi_u16  zone_avg[VI_MAX_PIPE_NUM][ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM];
} hi_isp_fe_ae_stitch_stat_3;

typedef struct {
    hi_u32  pixel_count;
    hi_u32  pixel_weight;
    hi_u32  histogram_mem_array[HIST_NUM];
} hi_isp_be_ae_stat_1;
...
typedef struct {
    hi_u16  zone_avg[AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM];
} hi_isp_be_ae_stat_3;

typedef struct {
    hi_u16  zone_avg[VI_MAX_PIPE_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM];
