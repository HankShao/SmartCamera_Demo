...
typedef enum hiEN_VI_ERR_CODE_E {
    ...
    ERR_VI_INVALID_MCFGRPID             /* invlalid mcf group ID */
} EN_VI_ERR_CODE_E;
...
typedef enum hiVI_MONO_COLOR_RATIO_E {
    VI_MONO_COLOR_RATIO_1_1 = 0,        /* The ratio of mono pic to color pic is 1:1 */
    VI_MONO_COLOR_RATIO_2_1,            /* The ratio of mono pic to color pic is 2:1 */
    VI_MONO_COLOR_RATIO_3_1,            /* The ratio of mono pic to color pic is 3:1 */
    VI_MONO_COLOR_RATIO_1_2,            /* The ratio of mono pic to color pic is 1:2 */
    VI_MONO_COLOR_RATIO_1_3,            /* The ratio of mono pic to color pic is 1:3 */
    VI_MONO_COLOR_RATIO_BUTT
} VI_MONO_COLOR_RATIO_E;

/* Information of mcf group */
typedef struct hiVI_MCF_GRP_ATTR_S {
    HI_BOOL  bEnable;
    VI_MONO_COLOR_RATIO_E enRatio;
    VI_PIPE  MonoPipe;
    VI_PIPE  ColorPipe;
} VI_MCF_GRP_ATTR_S;
