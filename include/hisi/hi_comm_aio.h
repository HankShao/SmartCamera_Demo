...
#define AEC_ERL_BAND_NUM       6
#define AEC_ERL_BAND_VALUE_NUM 7
...
typedef struct hiAI_AEC_CONFIG_S {
    ...
    HI_S16 s16ERLBand[AEC_ERL_BAND_NUM];    /* ERL protect area, [1, 63] for 8k, [1, 127] for 16k,
                                               frequency band calculated by s16ERLBand * 62.5,
                                               besides, s16ERLBand[n+1] should be greater than s16ERLBand[n] */
    HI_S16 s16ERL[AEC_ERL_BAND_VALUE_NUM];  /* ERL protect value of ERL protect area,
