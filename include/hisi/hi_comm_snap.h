...
#ifndef HI_COMM_SNAP_H
#define HI_COMM_SNAP_H
...
typedef struct hiSNAP_NORMAL_ATTR_S {
    ...
    HI_U32  u32RepeatSendTimes;  /* [0, 3]; When FE-BE is offline, the first raw frame that is triggered should be sent
