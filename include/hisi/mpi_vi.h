...
HI_S32 HI_MPI_VI_SetPipeRepeatMode(VI_PIPE ViPipe, const VI_PIPE_REPEAT_MODE_E enRepeatMode);
HI_S32 HI_MPI_VI_GetPipeRepeatMode(VI_PIPE ViPipe, VI_PIPE_REPEAT_MODE_E *penRepeatMode);
...
HI_S32 HI_MPI_VI_LDCPosQueryDst2Src(VI_PIPE ViPipe, VI_CHN ViChn,
    const POINT_S *pstDstPointIn, POINT_S *pstSrcPointOut);
HI_S32 HI_MPI_VI_LDCPosQuerySrc2Dst(VI_PIPE ViPipe, VI_CHN ViChn,
    const POINT_S *pstSrcPointIn, POINT_S *pstDstPointOut);
...
HI_S32 HI_MPI_VI_SetChnDISParam(VI_PIPE ViPipe, VI_CHN ViChn, const DIS_PARAM_S *pstDISParam);
HI_S32 HI_MPI_VI_GetChnDISParam(VI_PIPE ViPipe, VI_CHN ViChn, DIS_PARAM_S *pstDISParam);
...
/* 5 for vi mcf group */
HI_S32 HI_MPI_VI_SetMcfAttr(VI_MCF_GRP McfGrp, const VI_MCF_GRP_ATTR_S *pstMcfGrpAttr);
HI_S32 HI_MPI_VI_GetMcfAttr(VI_MCF_GRP McfGrp, VI_MCF_GRP_ATTR_S *pstMcfGrpAttr);
