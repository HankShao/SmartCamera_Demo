...
extern void osal_spin_unlock_irqrestore(osal_spinlock_t *lock, const unsigned long *flags);
/* notice:must be called when kmod exit, other wise will lead to memory leak; */
...
extern int osal_wait_interruptible(osal_wait_t *wait, osal_wait_cond_func_t func, const void *param);
extern int osal_wait_uninterruptible(osal_wait_t *wait, osal_wait_cond_func_t func, const void *param);
extern int osal_wait_timeout_interruptible(osal_wait_t *wait, osal_wait_cond_func_t func, const void *param,
                                           unsigned long ms);
extern int osal_wait_timeout_uninterruptible(osal_wait_t *wait, osal_wait_cond_func_t func, const void *param,
                                             unsigned long ms);
