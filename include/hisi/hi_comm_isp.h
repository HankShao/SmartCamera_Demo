 ...
 * Description: Function of hi_comm_isp.h
 * Author: ISP SW
 * Create: 2012/06/28
 */
...
/* MACRO DEFINITION */
#define res_width_max(dev)              (isp_get_max_width(dev))
#define RES_WIDTH_MIN                   120
#define res_height_max(dev)             (isp_get_max_height(dev))
#define RES_HEIGHT_MIN                  120
#define ISP_ALIGN_WIDTH                 4
#define ISP_ALIGN_HEIGHT                4
#define FRAME_RATE_MAX                  65535.0

#define ISP_BE_BUF_NUM_MAX              9
#define ISP_BE_BUF_NUM_MIN              2

#define VREG_MAX_NUM                    16

#define AWB_ZONE_ORIG_ROW               32
#define AWB_ZONE_ORIG_COLUMN            32
#define AWB_ZONE_BIN_MAX                 4
#define AE_ZONE_ROW                     15
#define AE_ZONE_COLUMN                  17
#define AE_PLANE_NUM                     4
...
#define AF_ALIGN_WIDTH                  8
#define AF_ALIGN_HEIGHT                 2
#define AF_PLGS_NUM                     2
...
#define ISP_MAX_SNS_EXP_ADDR_NUM        3
...
#define HI_ISP_RLSC_GAIN_LUT_NUM          3
#define HI_ISP_RLSC_SCALE_NUM             14
...
#define HI_ISP_ACS_CCT_NUM                3
#define HI_ISP_ACS_HIST_NUM               10
...
#define ISP_HRS_NUM                     6

#define ISP_CSC_DC_NUM                  3
#define ISP_CSC_COEF_NUM                9
...
typedef struct hiISP_MOD_PARAM_S {
    ...
    HI_BOOL  bLongFrmIntEn;    /* when wdr mode enable/disable long frame pipe interrupt.   */
                               /* Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
} ISP_MOD_PARAM_S;

/* Defines the structure of ISP control parameters. */
typedef struct hiISP_CTRL_PARAM_S {
    HI_U8   u8BeBufNum;      /* RW;Range:[2, 9]; offline be cfg buffer number(Only used for offline mode).
                                Not support changed after isp init */
    HI_U32  u32ProcParam;    /* RW;Format:32.0; Indicate the update frequency of ISP_PROC information,
                                No distinction vipipe */
    HI_U32  u32StatIntvl;    /* RW;Range:(0, 0xffffffff];Format:32.0;
                                Indicate the time interval of ISP statistic information */
    HI_U32  u32UpdatePos;    /* RW;Range:[0, 1]; Format:32.0; Indicate the location of the configuration register of
                                ISP interrupt */
...
typedef struct hiISP_PIPE_DIFF_ATTR_S {
    HI_S32 as32Offset[ISP_BAYER_CHN_NUM];   /* RW;Range:[-4095, 4095];Format:12.0; Black level differences between the
                                               offset value */
    HI_U32 au32Gain[ISP_BAYER_CHN_NUM];     /* RW;Range:[0x80, 0x400];Format:4.8; The gain difference ratio */
    HI_U16 au16ColorMatrix[CCM_MATRIX_SIZE]; /* RW;Range:[0x0, 0xFFFF];Format:8.8;
                                                Color correction matrix variance ratio */
...
typedef union hiISP_MODULE_CTRL_U {
    ...
    struct {
        ...
        HI_U64  bitBypassRadialCrop    : 1; /* RW;[15]; Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/
                                               Hi3559V200/Hi3556V200 */
        HI_U64  bitBypassSharpen       : 1; /* RW;[16] */
        HI_U64  bitBypassLCAC          : 1; /* RW;[17] */
        HI_U64  bitBypassGCAC          : 1; /* RW;[18]; Not support for Hi3516EV200/
        ...
        HI_U64  bitBypassRadialShading : 1; /* RW;[23]; Only used for Hi3559AV100/Hi3519AV100 */
        HI_U64  bitBypassAEStatFE      : 1; /* RW;[24] */
        HI_U64  bitBypassAEStatBE      : 1; /* RW;[25] */
        HI_U64  bitBypassMGStat        : 1; /* RW;[26] */
        HI_U64  bitBypassDE            : 1; /* RW;[27]; Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/
                                               Hi3559V200/Hi3556V200 */
        HI_U64  bitBypassAFStatFE      : 1; /* RW;[28]; Only used for Hi3559AV100/Hi3519AV100 */
        ...
        HI_U64  bitBypassCLUT          : 1; /* RW;[31]; Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/
                                               Hi3516DV200 */
        HI_U64  bitBypassHLC           : 1; /* RW;[32]; Not support for Hi3559AV100/Hi3516EV200/
                                               Hi3516EV300/Hi3518EV300/Hi3516DV200 */
        HI_U64  bitBypassEdgeMark      : 1; /* RW;[33]; Not support for Hi3516EV200/Hi3516EV300/
 ...
 * 0 = the raw data is writing out before the DEMOSAIC  module.
 * Only used for Hi3559AV100
 */
typedef enum hiISP_RAW_POS_E {
    RAW_POS_DEMOSAIC    = 0,
    RAW_POS_BUTT
} ISP_RAW_POS_E;

/*
 * Defines the RAW stream Position from the ISP and whether the function of geting raw data is enable.
 * Only used for Hi3559AV100
 */
typedef struct hiISP_RAW_POS {
    ISP_RAW_POS_E enRawPos;
    HI_BOOL bEnable;
} ISP_RAW_POS;
...
typedef struct hiISP_WDR_COMBINE_ATTR_S {
    HI_BOOL bMotionComp;        /* RW;Range:[0, 0x1];Format:1.0; enable/disable motion compensation */
    HI_U16  u16ShortThr;        /* RW;Range:[0, 0xFFF];Format:12.0; Data above this threshold will be taken from
                                   short exposure only. */
    HI_U16  u16LongThr;         /* RW;Range:[0, 0xFFF];Format:12.0; limited range :[0, u16ShortThr], Data below this
                                   threshold will be taken from long exposure only. */
    HI_BOOL bForceLong;         /* RW;Range:[0, 1];Format:1.0; enable/disable Force Long,
                                   Not support for Hi3559AV100 */
    HI_U16  u16ForceLongLowThr; /* RW;Range:[0, 0xFFF];Format:12.0; Data above this threshold will Force to choose
                                   long frame only, Not support for Hi3559AV100 */
    HI_U16  u16ForceLongHigThr; /* RW;Range:[0, 0xFFF];Format:12.0; Data below this threshold will Force to choose
                                   long frame only, Not support for Hi3559AV100 */
    ISP_FSWDR_MDT_ATTR_S stWDRMdt;
} ISP_WDR_COMBINE_ATTR_S;

typedef struct hiISP_FUSION_ATTR_S {
    HI_U16  au16FusionThr[WDR_MAX_FRAME_NUM];      /* RW;Range:[0x0, 0x3FFF];Format:14.0;The threshold of the 4 frame */
} ISP_FUSION_ATTR_S;

typedef struct hiISP_WDR_BNR_ATTR_S {
    ISP_BNR_MODE_E enBnrMode;         /* RW;Range:[0, 1];Format:1.0; enable/disable the bnr of wdr */
    HI_BOOL bShortFrameNR;     /* RW;Range:[0, 1];Format:1.0; enable/disable the bnr of short frame;
                                   Only used for Hi3519AV100 */
    HI_U8   u8ShortFrameNRStr; /* RW;Range:[0, 0x3F];Format:8.0;the Level 2 short frame sigma weight of G channel,
                                  Only used for Hi3519AV100 */
    ...
    HI_U8   u8FullMdtSigGWgt;  /* RW;Range:[0, 0x1F];Format:8.0,Only used for Hi3519AV100 */
    HI_U8   u8FullMdtSigRBWgt; /* RW;Range:[0, 0x1F];Format:8.0,Only used for Hi3519AV100 */
    HI_U8   u8FullMdtSigWgt;  /* RW;Range:[0, 0x1F];Format:8.0,Only used for Hi3559AV100 */
    HI_U8   au8GsigmaGain[3];  /* RW;Range:[0, 0xFF];Format:8.0,Only used for Hi3559AV100/Hi3519AV100 */
    HI_U8   au8RBsigmaGain[3]; /* RW;Range:[0, 0xFF];Format:8.0,Only used for Hi3559AV100/Hi3519AV100 */
} ISP_WDR_BNR_ATTR_S;

typedef struct hiISP_WDR_FS_ATTR_S {
    ISP_WDR_MERGE_MODE_E enWDRMergeMode;
    ISP_WDR_COMBINE_ATTR_S stWDRCombine;
    ISP_WDR_BNR_ATTR_S stBnr; /* Only used for Hi3559AV100/Hi3519AV100 */
    ISP_FUSION_ATTR_S stFusion;
    ISP_WDR_WBGAIN_POSITION_E enWDRWbgainPosition; /* RW; Range: [0x0, 0x1]; WDR Gain with or without WB Gain.
                                                      Only used for Hi3559AV100 */
} ISP_WDR_FS_ATTR_S;

typedef struct hiISP_DRC_CUBIC_POINT_ATTR_S {
    HI_U16 u16X;     /* RW; Range:[0, 1000]; Format:10.0; x position of the characteristic point of the cubic curve;
                        Only used for Hi3559AV100 */
    HI_U16 u16Y;     /* RW; Range:[0, 1000]; Format:10.0; y position of the characteristic point of the cubic curve;
                        Only used for Hi3559AV100 */
    HI_U16 u16Slope; /* RW; Range:[0, 10000]; Format:14.0; slope of the characteristic point of the cubic curve;
                        Only used for Hi3559AV100 */
...
typedef struct hiISP_DRC_MANUAL_ATTR_S {
    HI_U16  u16Strength; /* RW; Range:Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                            ...
                            Strength of dynamic range compression. Higher values lead to higher differential gain
...
typedef struct hiISP_DRC_AUTO_ATTR_S {
    ...
    HI_U16 u16StrengthMax; /* RW; Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                              Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF] | Hi3516AV300 = [0x0, 0x3FF] |
                              Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF] | Hi3516EV200 = [0x0, 0x3FF]|
                              Hi3516EV300 = [0x0, 0x3FF] | Hi3518EV300 = [0x0, 0x3FF]| Hi3516DV200 = [0x0, 0x3FF];
                              Maximum DRC strength in Auto mode */
    HI_U16 u16StrengthMin; /* RW; Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                              Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF] | Hi3516AV300 = [0x0, 0x3FF] |
                              Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF]| Hi3516EV200 = [0x0, 0x3FF] |
                              Hi3516EV300 = [0x0, 0x3FF]|Hi3518EV300 = [0x0, 0x3FF]|Hi3516DV200 = [0x0, 0x3FF];
...
typedef struct hiISP_DRC_ATTR_S {
    ...
    HI_U8  u8PDStrength;           /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the purple detection strength,
                                      ...
                                      Hi3559V200/Hi3556V200 */
    HI_U8  u8LocalMixingBrightMax; /* RW; Range:[0x0, 0x80]; Format:8.0;
                                      Maximum enhancement strength for positive detail */
    HI_U8  u8LocalMixingBrightMin; /* RW; Range:[0x0, 0x40]; Format:8.0;
                                      Minimum enhancement strength for positive detail */
    HI_U8  u8LocalMixingBrightThr; /* RW; Range:[0x0, 0xFF]; Format:8.0; Luma threshold for enhancement strength
                                      adaptation of positive detail */
    HI_S8  s8LocalMixingBrightSlo; /* RW; Range:[-7, 7]; Format:s4.0; Enhancement strength adaptation slope for
                                      positive detail */
    HI_U8  u8LocalMixingDarkMax;   /* RW; Range:[0x0, 0x80]; Format:8.0;
                                      Maximum enhancement strength for negative detail */
    HI_U8  u8LocalMixingDarkMin;   /* RW; Range:[0x0, 0x40]; Format:8.0;
                                      Minimum enhancement strength for negative detail */
    HI_U8  u8LocalMixingDarkThr;   /* RW; Range:[0x0, 0xFF]; Format:8.0; Luma threshold for enhancement strength
                                      adaptation of negative detail */
    HI_S8  s8LocalMixingDarkSlo;   /* RW; Range:[-7, 7]; Format:s4.0; Enhancement strength adaptation slope for
                                      negative detail */
    HI_U8  u8DetailBrightStr;      /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the gain of the non-linear positive
                                      detail enhancement; Only used for Hi3559AV100 */
    HI_U8  u8DetailDarkStr;        /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the gain of the non-linear negative
                                      detail enhancement; Only used for Hi3559AV100 */
    HI_U8  u8DetailBrightStep;     /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the step of the non-linear positive
                                      detail enhancement; Only used for Hi3559AV100 */
    HI_U8  u8DetailDarkStep;       /* RW; Range:[0x0, 0x80]; Format:8.0; Controls the step of the non-linear negative
                                      detail enhancement; Only used for Hi3559AV100 */
    ...
    HI_U16 au16ColorCorrectionLut[HI_ISP_DRC_CC_NODE_NUM]; /* RW; Range:[0x0, 0x400]; Format:4.12;
                                                              LUT of color correction coefficients */
    HI_U16 au16ToneMappingValue[HI_ISP_DRC_TM_NODE_NUM];   /* RW; Range:[0x0, 0xffff]; Format:16.0;
                                                              LUT of user-defined curve */

    HI_U8  u8FltScaleCoarse;     /* RW; Range:[0x0, 0xF]; Format:4.0; Spatial filter scale coarse control;
                                    Only used for Hi3559AV100 and Hi3519AV100 */
    HI_U8  u8FltScaleFine;       /* RW; Range:[0x0, 0xF]; Format:4.0; Spatial filter scale fine control;
                                    Only used for Hi3559AV100 and Hi3519AV100  */
    ...
    HI_U8  u8SpatialFltCoef;     /* RW; Range: Hi3559AV100 = [0x0, 0xA] | Hi3519AV100 = [0x0, 0x5] |
    ...
    HI_U8  u8RangeAdaMax;        /* RW; Range:[0x0, 0x8]; Format:4.0;
                                    Maximum range filter coefficient adaptation range */
    ...
    HI_U8  u8DpDetectRangeRatio; /* RW; Range:[0x0, 0x1F]; Format:5.0; DRC defect pixel detection control parameter;
                                    Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U8  u8DpDetectThrSlo;     /* RW; Range:[0x0, 0x1F]; Format:5.0; DRC defect pixel detection control parameter;
                                    Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16 u16DpDetectThrMin;    /* RW; Range:[0x0, 0xFFFF]; Format:16.0; DRC defect pixel detection control parameter;
                                    Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
...
typedef struct hiISP_LDCI_GAUSS_COEF_ATTR_S {
    HI_U8   u8Wgt;   /* RW;Range:Hi3559AV100 = [0x0, 0x80] | Hi3519AV100 = [0x0, 0x80]| Hi3516CV500 = [0x0, 0xFF] |
...
typedef struct hiISP_LDCI_AUTO_ATTR_S {
    ...
    HI_U16                  au16BlcCtrl[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range: [0x0, 0x1FF];Format:9.0;
                                                                       auto mode, Restrain dark region */
} ISP_LDCI_AUTO_ATTR_S;

typedef struct hiISP_LDCI_ATTR_S {
    HI_BOOL                bEnable;         /* RW;Range:[0x0,0x1];Format:1.0; */
    HI_U8                  u8GaussLPFSigma; /* RW;Range: [0x1, 0xFF];Format:0.8;
                                               Coefficient of Gaussian low-pass filter */
    ISP_OP_TYPE_E          enOpType;
    ISP_LDCI_MANUAL_ATTR_S stManual;
    ISP_LDCI_AUTO_ATTR_S   stAuto;
    HI_U16                 u16TprIncrCoef;  /* RW;Range: [0x0, 0x100];Format:0.9;
                                               Increase Coefficient of temporal filter */
    HI_U16                 u16TprDecrCoef;  /* RW;Range: [0x0, 0x100];Format:0.9;
...
typedef struct hiISP_CA_ATTR_S {
    HI_BOOL bEnable;            /* RW;Range:[0x0,0x1];Format:1.0 */
    ISP_CA_TYPE_E eCaCpEn;      /* Only used for Hi3559AV100/Hi3519AV100 */
    ISP_CA_LUT_S stCA;
    ISP_CP_LUT_S stCP;          /* Only used for Hi3559AV100/Hi3519AV100 */
} ISP_CA_ATTR_S;

typedef struct hiCSC_MATRX_S {
    HI_S16 as16CSCIdc[ISP_CSC_DC_NUM];  /* RW; Range:[-1024, 1023]; Format: 11.0; Input dc component for csc matrix */
    HI_S16 as16CSCOdc[ISP_CSC_DC_NUM];  /* RW; Range:[-1024, 1023]; Format: 11.0; Output dc component for csc matrix */
    HI_S16 as16CSCCoef[ISP_CSC_COEF_NUM]; /* RW; Range:[-4096, 4095]; Format: 5.10; 3x3 coefficients for csc matrix */
} CSC_MATRX_S;

typedef struct hiISP_CSC_ATTR_S {
    HI_BOOL bEnable;            /* RW; Range:[0, 1];Format:1.0; Enable/Disable CSC Function */

    COLOR_GAMUT_E enColorGamut; /* RW; Range: [0, 3]; Color gamut type; COLOR_GAMUT_BT2020 only used for Hi3559AV100 */
    ...
    HI_BOOL bLimitedRangeEn;    /* RW; Range: [0x0, 0x1]; Enable/Disable:
                                   Enable Limited range output mode(default full range output) */
...
typedef struct hiISP_CLUT_LUT_S {
    HI_U32 au32lut[HI_ISP_CLUT_LUT_LENGTH]; /* RW; Range: Hi3559AV100 = [0, 4294967295] |
                                               Hi3519AV100 = [0x0, 1073741823]| Hi3516CV500 = [0x0, 1073741823]|
                                               Hi3516DV300 = [0x0, 1073741823] | Hi3516AV300 = [0x0, 1073741823] |
                                               Hi3559V200 = [0x0, 1073741823]| Hi3556V200 = [0x0, 1073741823];
                                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
} ISP_CLUT_LUT_S;
...
typedef struct hiISP_DP_STATIC_CALIBRATE_S {
    HI_BOOL bEnableDetect;               /* RW; Range: [0, 1];Format 1.0;Set 'HI_TRUE'to start static defect-pixel
                                            calibration, and firmware will set 'HI_FALSE' when finished,
                                            Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    ISP_STATIC_DP_TYPE_E enStaticDPType; /* RW; Range: [0, 1];Format 1.0;Select static bright/dark defect-pixel
    ...
    HI_U8   u8StartThresh; /* RW; Range: [1, 255]; Format 8.0;Start threshold for static defect-pixel calibraiton,
                              Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  u16CountMax;   /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144] |
                              ...
                              Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  u16CountMin;   /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144] |
                              Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]| Hi3559V200 = [0, 6144] |
                              Hi3556V200 = [0, 6144];Format 14.0; limited Range: [0, u16CountMax],
                              Limit of min number of static defect-pixel calibraiton.
                              Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  u16TimeLimit;  /* RW; Range: [0x0, 1600];Format 11.0;Time limit for static defect-pixel calibraiton, in
                              frame number,Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */

    HI_U32  au32Table[STATIC_DP_COUNT_MAX]; /* R; Range: [0, 0x1FFF1FFF];Format 29.0;
    ...
    HI_U8   u8FinishThresh; /* R; Range: [0, 255];Format 8.0; Finish threshold for static defect-pixel calibraiton,
                                  Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  u16Count;       /* R; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192] Hi3516CV500 = [0, 6144]|
                               Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]| Hi3559V200 = [0, 6144] |
...
typedef struct hiISP_DP_STATIC_ATTR_S {
    HI_BOOL bEnable;        /* RW; Range: [0, 1];Format 1.0;Enable/disable the static defect-pixel module,
                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  u16BrightCount; /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144]|
                               Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]| Hi3559V200 = [0, 6144] |
                               Hi3556V200 = [0, 6144];Format 14.0;limited Range: [0, STATIC_DP_COUNT_NORMAL*BlkNum],
                               ...
                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  u16DarkCount;   /* RW; Range:Hi3559AV100 = [0, 8192] | Hi3519AV100 = [0, 8192]| Hi3516CV500 = [0, 6144]|
                               Hi3516DV300 = [0, 6144]| Hi3516AV300 = [0, 6144]|Hi3559V200 = [0, 6144] |
                               Hi3556V200 = [0, 6144];Format 14.0;limited Range: [0, STATIC_DP_COUNT_NORMAL*BlkNum],
                               When used as input(W), indicate the number of static dark defect pixels;
                               As output(R), invalid value 0.
                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U32  au32BrightTable[STATIC_DP_COUNT_MAX]; /* RW; Range: [0x0, 0x1FFF1FFF];Format 29.0;
                                                     0~12 bits represents the X coordinate of the defect pixel,
                                                     16~28 bits represent the Y coordinate of the defect pixel
                                                     Notice: When used as input(W), indicate static bright defect
                                                     pixels table; As output(R), indicate static bright and dark defect
                                                     pixels table.
                                                     Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */

    HI_U32  au32DarkTable[STATIC_DP_COUNT_MAX];  /* RW; Range: [0x0, 0x1FFF1FFF];Format 29.0;
                                                    0~12 bits represents the X coordinate of the defect pixel,
                                                    16~28 bits represent the Y coordinate of the defect pixel
                                                    Notice: When used as input(W), indicate static dark defect pixels
                                                    table; As output(R), invalid value.
                                                    Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
...
typedef struct hiISP_DP_DYNAMIC_AUTO_ATTR_S {
    ...
    HI_U16 au16BlendRatio[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 128];Format:9.0;
...
typedef struct hiISP_DP_DYNAMIC_ATTR_S {
    ...
    HI_U8   u8SoftSlope;        /* RW; Range: [0, 255];Format 8.0;Correction controlling parameter of the pixels
                                   whose deviation is smaller than s8SoftThr. */
...
typedef struct hiISP_SHADING_ATTR_S {
    ...
    HI_U16  u16MeshStr;    /* RW; Range:Hi3559AV100=[0, 65535]| Hi3519AV100=[0, 65535]|Hi3516CV500=[0, 65535]|
...
typedef struct hiISP_SHADING_LUT_S {
    HI_U16  au16RGain[HI_ISP_LSC_GRID_POINTS];  /* RW; Range:[0, 1023];Member used to store the calibration data of the
                                                   R channel required for LSC. */
    HI_U16  au16GrGain[HI_ISP_LSC_GRID_POINTS]; /* RW; Range:[0, 1023];Member used to store the calibration data of the
                                                   Gr channel required for LSC. */
    HI_U16  au16GbGain[HI_ISP_LSC_GRID_POINTS]; /* RW; Range:[0, 1023];Member used to store the calibration data of the
                                                   Gb channel required for LSC. */
    HI_U16  au16BGain[HI_ISP_LSC_GRID_POINTS];  /* RW; Range:[0, 1023];Member used to store the calibration data of the
                                                   B channel required for LSC. */
} ISP_SHADING_GAIN_LUT_S;

typedef struct hiISP_BNR_LSC_GAIN_LUT_S {
    HI_U16  au16RGain[HI_ISP_RLSC_POINTS];  /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                               R channel required for BNR_LSC.
                                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  au16GrGain[HI_ISP_RLSC_POINTS]; /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                               Gr channel required for BNR_LSC.
                                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  au16GbGain[HI_ISP_RLSC_POINTS]; /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                               Gb channel required for BNR_LSC.
                                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16  au16BGain[HI_ISP_RLSC_POINTS];  /* RW; Range:[0, 65535];Member used to store the calibration data of the
                                               B channel required for BNR_LSC.
                                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
} ISP_BNR_LSC_GAIN_LUT_S;

typedef struct hiISP_SHADING_LUT_ATTR_S {
    HI_U8  u8MeshScale;        /* RW; Range:[0, 7];Format:3.0;Three bit value that selects the scale and precision for
                                  the 10 bit gain coefficients stored in mesh tables */
    HI_U16 au16XGridWidth[HI_ISP_MLSC_X_HALF_GRID_NUM]; /* RW; Range:Hi3559AV100=[4, 1988]| Hi3519AV100=[4, 1988]|
    ...
    HI_U16 au16YGridWidth[HI_ISP_MLSC_Y_HALF_GRID_NUM]; /* RW; Range:Hi3559AV100=[4, 1988]| Hi3519AV100=[4, 1988]|
                                                      Hi3516CV500=[4, 1092]|Hi3516DV300=[4, 1092]|
                                                      Hi3516AV300=[4, 1092]|Hi3559V200=[4, 1092]|
                                                      Hi3556V200=[4, 1092]|Hi3516EV200 = [4,255]|
                                                      Hi3516EV300 =[4,255]| Hi3518EV300 = [4,255 ]|
    ...
    ISP_SHADING_GAIN_LUT_S astLscGainLut[HI_ISP_MLSC_GAIN_LUT_NUM];
    ISP_BNR_LSC_GAIN_LUT_S stBNRLscGainLut; /* Not support for Hi3559AV100/Hi3519AV100/Hi3516EV200/Hi3516EV300 */
...
typedef struct hiISP_MLSC_CALIBRATION_CFG_S {
    ...
    HI_U16  u16DstImgHeight; /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, u16ImgHeight], Image height that
                                crop from input raw image, set to ImgHeight if don't need to crop */
    HI_U16  u16DstImgWidth;  /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, u16ImgWidth], Image width that
                                crop from input raw image, set to ImgWidth if don't need to crop */
    HI_U16  u16OffsetX;      /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, u16ImgWidth - u16DstImgWidth],
                                Horizontal offset that crop from input raw image, set to 0 if don't need to crop */
    HI_U16  u16OffsetY;      /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, u16ImgHeight - u16DstImgHeight],
...
typedef struct hiISP_MESH_SHADING_TABLE_S {
    HI_U8  u8MeshScale;       /* RW; Range:[0, 7];Format:3.0;Three bit value that selects the scale and precision for
                                  the 10 bit gain coefficients stored in mesh tables */
    HI_U16 au16XGridWidth[HI_ISP_MLSC_X_HALF_GRID_NUM]; /* RW; Range:Hi3559AV100=[4, 16323]| Hi3519AV100=[4, 16323]|
                                                      ...
                                                      Member used to store the width data of each GRID partition */
    HI_U16 au16YGridWidth[HI_ISP_MLSC_Y_HALF_GRID_NUM]; /* RW; Hi3559AV100=[4, 16323]| Hi3519AV100=[4, 16323]|
                                                      Hi3516CV500=[4, 16323]|Hi3516DV300=[4, 16323]|
                                                      Hi3516AV300=[4, 16323]| Hi3559V200=[4, 16323] |
                                                      Hi3556V200=[4, 16323]|Hi3516EV200 = [4,255]|
                                                      Hi3516EV300 =[4,255]| Hi3518EV300 = [4,255 ]|
...
typedef struct hiISP_RADIAL_SHADING_ATTR_S {
    HI_BOOL bEnable;          /* RW; Range:[0, 1];Format:1.0; enable/disable rlsc */
    HI_U16  u16RadialStr;     /* RW; Range:[0, 65535];Format:4.12; the strength of the mesh shading correctio */
...
typedef struct hiISP_RADIAL_SHADING_LUT_ATTR_S {
    ...
    HI_U16  u16BlendRatio;         /* RW; Range:[0, 256];Format:8.0; Used in manual mode only, indicates the light
                                      blending strength for the first light info */
    HI_U8   u8LightType1;          /* RW; Range:[0, 2];Format:2.0; Used in manual mode only, indicates the first light
                                     source selected */
    HI_U8   u8LightType2;          /* RW; Range:[0, 2];Format:2.0; Used in manual mode only, indicates the second light
                                      source selected */
    HI_U8   u8RadialScale;         /* RW; Range:[0, 13];Format:4.0;Four bit value that selects the scale and precision
                                      for the 10 bit gain coefficients */
    HI_U16  u16CenterRX;     /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width - 1], shows x value of the
                                position of optical center of red channel */
    HI_U16  u16CenterRY;     /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height - 1], shows y value of the
                                position of optical center of red channel */
    HI_U16  u16CenterGrX;    /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width - 1], shows x value of the
                                position of optical center of gr channel */
    HI_U16  u16CenterGrY;    /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height - 1], shows y value of the
                                position of optical center of gr channel */
    HI_U16  u16CenterGbX;    /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width - 1], shows x value of the
                                position of optical center of gb channel */
    HI_U16  u16CenterGbY;    /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height - 1], shows y value of the
                                position of optical center of gb channel */
    HI_U16  u16CenterBX;     /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width - 1], shows x value of the
                                position of optical center of blue channel */
    HI_U16  u16CenterBY;     /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height - 1], shows y value of the
                                position of optical center of blue channel */
    ...
    ISP_RADIAL_SHADING_GAIN_LUT_S astRLscGainLut[HI_ISP_RLSC_GAIN_LUT_NUM];
...
typedef struct hiISP_RLSC_CALIBRATION_CFG_S {
    ...
    HI_U16  u16CenterX;       /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, u16ImgWidth - u16DstImgWidth],
                               Horizontal offset that crop from input raw image, set to 0 if don't need to crop */
    HI_U16  u16CenterY;       /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, u16ImgHeight - u16DstImgHeight],
                               Vertical offset that crop from input raw image, set to 0 if don't need to crop */
    HI_U16  u16Radius;        /* RW; Range: [0, 65535];Format 16.0; radius of the area need to calibrate */

    HI_U16  u16RadialScale;  /* RW; Range: [0, 7];Format 3.0; Shows Mesh Scale value */

    HI_U16  u16BlcOffsetR;  /* RW; Range: [0, 4095];Format 12.0;BLC value for R channel */
    HI_U16  u16BlcOffsetGr; /* RW; Range: [0, 4095];Format 12.0;BLC value for Gr channel */
    HI_U16  u16BlcOffsetGb; /* RW; Range: [0, 4095];Format 12.0;BLC value for Gb channel */
    HI_U16  u16BlcOffsetB;  /* RW; Range: [0, 4095];Format 12.0;BLC value for B channel */
} ISP_RLSC_CALIBRATION_CFG_S;

typedef struct hiISP_RADIAL_SHADING_TABLE_S {
    HI_U8   u16RadialScale;       /* RW; Range:[0, 13];Format:4.0;Four bit value that selects the scale and precision
                                      for the 10 bit gain coefficients */
    HI_U16  u16CenterX; /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width - 1], shows x value of the position
                              of optical center */
    HI_U16  u16CenterY; /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height - 1], shows y value of the position
                              of optical center */
    HI_U16  u16OffCenter;   /* RW; Range:[0, 65535];Format:16.0;related to the 1/R^2 value of all channel */
    ISP_RADIAL_SHADING_GAIN_LUT_S stRlscGainLut; /* Only used for Hi3559AV100/Hi3519AV100 */
} ISP_RADIAL_SHADING_TABLE_S;

typedef struct {
    HI_BOOL bEnable;        /* RW; Range:[0, 1];Format:1.0;Acs Enable. */
    HI_U16  u16YStrength;   /* RW; Range:[0, 256];Format:8.0;Acs correction strength for y shading. */
    HI_U16  u16RunInterval; /* RW; Range:[1, 255];Format:16.0;Acs Run Interval. */
    HI_BOOL bLockEnable;    /* RW; Range:[0, 1];Format:1.0;Lock Gain Lut Enable. */
} ISP_ACS_ATTR_S;

typedef struct hiISP_NR_MANUAL_ATTR_S {
    HI_U8  au8ChromaStr[ISP_BAYER_CHN_NUM]; /* RW;Range:[0, 3];Format:2.0;
                                               Strength of Chrmoa noise reduction for R/Gr/Gb/B channel,
                                               Not support for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U8  u8FineStr;                    /* RW;Range:[0, 0x80];Format:8.0;Strength of Luma noise reduction */
    HI_U16 u16CoringWgt;                 /* RW;Range:[0, 0xc80];Format:12.0;Strength of reserving the random noise */
    HI_U16 au16CoarseStr[ISP_BAYER_CHN_NUM]; /* RW;Range:[0,0x360];Format:10.0;Coarse Strength of noise reduction */
} ISP_NR_MANUAL_ATTR_S;

typedef struct hiISP_NR_AUTO_ATTR_S {
    HI_U8   au8ChromaStr[ISP_BAYER_CHN_NUM][ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:[0, 3];Format:2.0;
                                                                            Strength of chrmoa noise reduction for
                                                                            R/Gr/Gb/B channel,
                                                                            Not support for Hi3516EV200/Hi3516EV300/
                                                                            Hi3518EV300/Hi3516DV200 */
    HI_U8   au8FineStr[ISP_AUTO_ISO_STRENGTH_NUM];                       /* RW;Range:[0, 0x80];Format:8.0;
                                                                            Strength of luma noise reduction */
    HI_U16  au16CoringWgt[ISP_AUTO_ISO_STRENGTH_NUM];                    /* RW;Range:[0, 0xc80];Format:12.0;
                                                                            Strength of reserving the random noise */
    HI_U16  au16CoarseStr[ISP_BAYER_CHN_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0, 0x360];Format:10.0;
                                                                            Coarse Strength of noise reduction */
} ISP_NR_AUTO_ATTR_S;

typedef struct hiISP_NR_WDR_ATTR_S {
    HI_U8 au8WDRFrameStr[WDR_MAX_FRAME_NUM];    /* RW;Range:[0, 0x50];Format:7.0;Strength of each frame in wdr mode */
    HI_U8 au8FusionFrameStr[WDR_MAX_FRAME_NUM]; /* RW;Range:[0, 0x50];Format:7.0;Strength of each frame in wdr mode.
...
typedef struct hiISP_NR_ATTR_S {
    HI_BOOL  bEnable;              /* RW;Range:[0, 0x1];Format:1.0; Nr Enable */
    HI_BOOL  bLowPowerEnable;      /* RW;Range:[0, 0x1];Format:1.0; Nr Low Power Enable.
                                      Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200/
                                      Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_BOOL  bNrLscEnable;         /* RW;Range:[0, 1];Format:1.0;
                                      HI_TRUE: Noise reduction refers to lens shading;
                                      HI_FALSE: Noise reduction not refers to lens shading; */
    HI_U8    u8NrLscRatio;         /* RW;Range:[0, 0xff];Format:8.0; Ratio of referring to lens shading.
                                      Not support  for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200/
                                      Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U8    u8BnrLscMaxGain;      /* RW;Range:[0, 0xbf];Format:2.6; Max gain for referring to lens shading.
                                      Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200/
                                      Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16   u16BnrLscCmpStrength; /* RW;Range:[0, 0x100];Format:1.8; Compare strength for referring to lens shading.
                                      Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200/
                                      Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16   au16CoringRatio[HI_ISP_BAYERNR_LUT_LENGTH]; /* RW;Range:[0x0, 0x3ff];Format:12.0;
...
typedef struct hiISP_DE_MANUAL_ATTR_S {
    HI_U16 u16GlobalGain;  /* RW;Range:[0x0,0x100];Format:1.8 */
    HI_U16 u16GainLF;     /* RW;Range:[0x0,0x20];Format:2.4 */
    HI_U16 u16GainHF;     /* RW;Range:[0x0,0x20];Format:2.4 */
} ISP_DE_MANUAL_ATTR_S;

/* Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
typedef struct hiISP_DE_AUTO_ATTR_S {
    HI_U16 au16GlobalGain[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0,0x100];Format:1.8 */
    HI_U16 au16GainLF[ISP_AUTO_ISO_STRENGTH_NUM];     /* RW;Range:[0x0,0x20];Format:2.4 */
    HI_U16 au16GainHF[ISP_AUTO_ISO_STRENGTH_NUM];     /* RW;Range:[0x0,0x20];Format:2.4 */
} ISP_DE_AUTO_ATTR_S;

/* Only used for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
typedef struct hiISP_DE_ATTR_S {
    HI_BOOL bEnable;                                    /* RW;Range:[0x0,0x1];Format:1.0; De Enable */
    HI_U16  au16LumaGainLut[HI_ISP_DE_LUMA_GAIN_LUT_N]; /* RW;Range:[0x0,0x100];Format:1.8 */
...
typedef struct hiISP_RGBIR_ATTR_S {
    HI_BOOL              bEnable;      /* RW;Range:[0x0, 0x1];Format:1.0; Enable/Disable RGBIR module */
    ISP_IRBAYER_FORMAT_E enInPattern;      /* RW;Range:[0x0, 0x7];Format:3.0; IR pattern of the input signal */
    ISP_BAYER_FORMAT_E   enOutPattern;     /* RW;Range:[0x0, 0x3];Format:2.0; Bayer pattern of the output signal */

    HI_U16               au16ExpCtrl[ISP_EXP_CTRL_NUM]; /* RW;Range:[0, 2047];Format:11.0;
                                                           Over expose control parameter */
    HI_U16               au16Gain[ISP_EXP_CTRL_NUM];    /* RW;Range:[0, 511];Format:9.0;
                                                           Over expose control  parameter */

    ISP_IR_CVTMAT_MODE_E enIRCvtMatMode;
    HI_S16               as16CvtMatrix[ISP_CVTMAT_NUM]; /* RW;Range:[-32768, 32767];Format:s15.0;  RGBIR to Bayer image
...
typedef struct hiISP_PREGAMMA_ATTR_S {
    ...
    HI_U32    au32Table[PREGAMMA_NODE_NUM]; /* RW; Range:Hi3559AV100 = [0, 0x100000] | Hi3519AV100 = [0, 0x100000] |
                                               ...
                                               Hi3516DV200 = [0x0,0xFFFFF]; Format:21.0;PreGamma LUT nodes value */
} ISP_PREGAMMA_ATTR_S;
...
typedef struct hiISP_SHARPEN_MANUAL_ATTR_S {
    HI_U8  au8LumaWgt[ISP_SHARPEN_LUMA_NUM];  /* RW; Range: Hi3559AV100 =[0, 127]|Hi3519AV100=[0, 127]|
    ...
    HI_U16 au16TextureStr[ISP_SHARPEN_GAIN_NUM]; /* RW; Range: [0, 4095]; Format:7.5;
                                                  Undirectional sharpen strength for texture and detail enhancement */
    HI_U16 au16EdgeStr[ISP_SHARPEN_GAIN_NUM];    /* RW; Range: [0, 4095]; Format:7.5;
                                                    Directional sharpen strength for edge enhancement */
    HI_U16 u16TextureFreq;         /* RW; Range: [0, 4095];Format:6.6; Texture frequency adjustment.
                                      Texture and detail will be finer when it increase */
    HI_U16 u16EdgeFreq;            /* RW; Range: [0, 4095];Format:6.6; Edge frequency adjustment.
    ...
    HI_U8  u8ShootSupStr;          /* RW; Range: [0, 255]; Format:8.0;overshoot and undershoot suppression strength,
                                      the amplitude and width of shoot will be decrease when shootSupSt increase */
    HI_U8  u8ShootSupAdj;          /* RW; Range: [0, 15]; Format:4.0;overshoot and undershoot suppression adjusting,
                                      adjust the edge shoot suppression strength */
    HI_U8  u8DetailCtrl;           /* RW; Range: [0, 255]; Format:8.0;Different sharpen strength for detail and edge.
                                      When it is bigger than 128, detail sharpen strength will be stronger than edge */
    HI_U8  u8DetailCtrlThr;        /* RW; Range: [0, 255]; Format:8.0; The threshold of DetailCtrl, it is used to
    ...
    HI_U8  u8WeakDetailGain;       /* RW; Range: [0, 127];
...
typedef struct hiISP_SHARPEN_AUTO_ATTR_S {
    HI_U8  au8LumaWgt[ISP_SHARPEN_LUMA_NUM][ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:Hi3559AV100 =[0, 127]|
                                                                          ...
                                                                          Hi3516EV300 = [0, 31]|Hi3518EV300 = [0x0, 31]|
                                                                          Hi3516DV200 = [0x0, 31]
                                                                          Format:0.7; Adjust the sharpen strength
                                                                          according to luma. Sharpen strength will be
                                                                          weaker when it decrease. */
    HI_U16 au16TextureStr[ISP_SHARPEN_GAIN_NUM][ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 4095]; Format:7.5;
                                                                                Undirectional sharpen strength for
                                                                                texture and detail enhancement */
    HI_U16 au16EdgeStr[ISP_SHARPEN_GAIN_NUM][ISP_AUTO_ISO_STRENGTH_NUM];     /* RW; Range: [0, 4095]; Format:7.5;
                                                                                Directional sharpen strength for edge
                                                                                enhancement */
    HI_U16 au16TextureFreq[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [0, 4095]; Format:6.6;Texture frequency
                                                            adjustment. Texture and detail will be finer
                                                            when it increase */
    HI_U16 au16EdgeFreq[ISP_AUTO_ISO_STRENGTH_NUM];      /* RW; Range: [0, 4095]; Format:6.6;Edge frequency adjustment.
                                                            Edge will be narrower and thiner when it increase */
    ...
    HI_U8  au8ShootSupStr[ISP_AUTO_ISO_STRENGTH_NUM];    /* RW; Range: [0, 255]; Format:8.0;overshoot and undershoot
                                                            suppression strength, the amplitude and width of shoot will
                                                            be decrease when shootSupSt increase */
    HI_U8  au8ShootSupAdj[ISP_AUTO_ISO_STRENGTH_NUM];    /* RW; Range: [0, 15]; Format:4.0;overshoot and undershoot
                                                            suppression adjusting, adjust the edge shoot suppression
                                                            strength */
    HI_U8  au8DetailCtrl[ISP_AUTO_ISO_STRENGTH_NUM];     /* RW; Range: [0, 255]; Format:8.0;Different sharpen strength
                                                            for detail and edge. When it is bigger than 128, detail
                                                            sharpen strength will be stronger than edge. */
    HI_U8  au8DetailCtrlThr[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 255]; Format:8.0;
                                                            The threshold of DetailCtrl, it is used to distinguish
                                                            detail and edge. */
    HI_U8  au8EdgeFiltStr[ISP_AUTO_ISO_STRENGTH_NUM];    /* RW; Range: [0, 63]; Format:6.0;
                                                            The strength of edge filtering. */
    HI_U8  au8EdgeFiltMaxCap[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: [0, 47]; Format:6.0;
                                                             The max capacity of edge filtering. */
    HI_U8  au8RGain[ISP_AUTO_ISO_STRENGTH_NUM];           /* RW; Range: [0, 31]; Format:5.0;
                                                             Sharpen Gain for Red Area */
    HI_U8  au8GGain[ISP_AUTO_ISO_STRENGTH_NUM];           /* RW; Range: [0, 255]; Format:8.0;
                                                             Sharpen Gain for Green Area */
    HI_U8  au8BGain[ISP_AUTO_ISO_STRENGTH_NUM];           /* RW; Range: [0, 31]; Format:5.0;
                                                             Sharpen Gain for Blue Area */
    ...
    HI_U8  au8WeakDetailGain[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range: [0, 127]; Format:7.0;
                                                        Only used for Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200;
                                                        sharpen Gain for weakdetail */
...
typedef struct hiISP_CR_ATTR_S {
    ...
    HI_U8   u8Slope;       /* RW; Range: Hi3559AV100 = [0, 14] | Hi3519AV100 = [0, 14]|Hi3516CV500 = [0, 14]|
    ...
    HI_U8   u8SensiSlope;  /* RW; Range: Hi3559AV100 = [0, 14] | Hi3519AV100 = [0, 14]|Hi3516CV500 = [0, 14]|
                              Hi3516DV300 =[0, 14]||Hi3516AV300 =[0, 14] | Hi3559V200 =[0, 14] |Hi3556V200 =[0, 14] |
                              Hi3516EV200 = [0, 16]|Hi3516EV300 = [0, 16]|Hi3518EV300 = [0, 16]|Hi3516DV200 = [0, 16];
                              Crosstalk sensitivity. */
    HI_U16  u16SensiThr;   /* RW; Range: Hi3559AV100 = [0, 16383] | Hi3519AV100 = [0, 16383]|Hi3516CV500 = [0, 16383]|
                              Hi3516DV300 =[0, 16383]|Hi3516AV300 =[0, 16383]| Hi3559V200 =[0, 16383]|
                              Hi3556V200 =[0, 16383]|Hi3516EV200 = [0,65535]|Hi3516EV300 = [0, 65535]|
                              Hi3518EV300 = [0, 65535]|Hi3516DV200 = [0, 65535];
                              Crosstalk sensitivity threshold. */
    HI_U16  au16Strength[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: [0,256];Crosstalk strength value. */
    HI_U16  au16Threshold[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW; Range: Hi3559AV100 = [0, 16383] |
                                                          Hi3519AV100 = [0, 16383]|Hi3516CV500 = [0, 16383]|
                                                          Hi3516DV300 =[0, 16383] | Hi3516AV300 =[0, 16383]|
                                                          Hi3559V200 =[0, 16383] |Hi3556V200 =[0, 16383] |
                                                          Hi3516EV200 = [0, 65535]| Hi3516EV300 = [0, 65535]|
                                                          Hi3518EV300 = [0, 65535]|Hi3516DV200 = [0, 65535];
                                                          Crosstalk threshold. */
    HI_U16  au16NpOffset[ISP_AUTO_ISO_STRENGTH_NUM];   /* RW; Range: Hi3559AV100 = [512, 16383] |
...
typedef struct hiISP_DEMOSAIC_MANUAL_ATTR_S {
    ...
    HI_U8   u8NonDirMFDetailEhcStr; /* RW; Range:Hi3559AV100 = [0x0, 0x10] |Hi3519AV100 = [0x0, 0x7f] |
    ...
    HI_U8   u8NonDirHFDetailEhcStr; /* RW; Range:[0x0, 0x10];  Format:2.2;
                                       Non-direction high frequent detail enhance strength */
    HI_U8   u8DetailSmoothRange;    /* RW; Range:Hi3559AV100 = [0x1, 0x8] |Hi3519AV100 = [0x1, 0x7] |
                                       Hi3516CV500 = [0x1, 0x7]|Hi3516DV300 = [0x1, 0x7]|
                                       Hi3516AV300 = [0x1, 0x7]|Hi3559V200 = [0x1, 0x7]|Hi3556V200 = [0x1, 0x7] |
                                       Hi3516EV200 = [0x1, 0x7]|Hi3516EV300 = [0x1, 0x7]|Hi3518EV300 = [0x1, 0x7]|
                                       Hi3516DV200 = [0x1, 0x7]; Format:4.0; Detail smooth range */
    HI_U16  u16DetailSmoothStr;     /* RW; Range:[0x0, 0x100]; Format:9.0; Strength of detail smooth,
                                       Only used for Hi3559AV100 */
    HI_U8   u8ColorNoiseThdF;       /* RW; Range:[0x0, 0xff]; Format:8.0; Threshold of color noise cancel */
    HI_U8   u8ColorNoiseStrF;       /* RW; Range:[0x0, 0x8]; Format:4.0; Strength of color noise cancel,
                                       Not available for Hi3559AV100 */
    HI_U8   u8ColorNoiseThdY;       /* RW; Range:Hi3559AV100 = [0x0, 0xFF] |Hi3519AV100 = [0x0, 0xFF] |
    ...
    HI_U8   u8ColorNoiseStrY;       /* RW; Range:Hi3559AV100 = [0x0, 0xFF] |Hi3519AV100 = [0x0, 0xFF] |
                                       Hi3516CV500 = [0x0, 0xFF] |Hi3516DV300 = [0x0, 0xFF] |
                                       Hi3516AV300 = [0x0, 0xFF] |Hi3559V200 = [0x0, 0xFF] |
...
typedef struct hiISP_DEMOSAIC_AUTO_ATTR_S {
    ...
    HI_U8  au8NonDirMFDetailEhcStr[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:Hi3559AV100 = [0x0, 0x10] |
                                                                 ...
                                                                 enhance strength */
    HI_U8  au8NonDirHFDetailEhcStr[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW; Range:[0x0, 0x10];  Format:2.2; Non-direction
                                                                  high frequent detail enhance strength */
    HI_U8  au8DetailSmoothRange[ISP_AUTO_ISO_STRENGTH_NUM];    /* RW; Range:Hi3559AV100 = [0x1, 0x8] |
    ...
    HI_U16 au16DetailSmoothStr[ISP_AUTO_ISO_STRENGTH_NUM]; /* RW;Range:[0x0, 0x100]; Format:9.0;
                                                              Strength of detail smooth, Only used for Hi3559AV100 */
    HI_U8  au8ColorNoiseThdF[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:[0x0, 0xff]; Format:8.0;
                                                             Threshold of color noise cancel */
    HI_U8  au8ColorNoiseStrF[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:[0x0, 0x8]; Format:4.0; Strength of color noise
                                                             cancel, Not available for Hi3559AV100 */
    HI_U8  au8ColorNoiseThdY[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:Hi3559AV100 = [0x0, 0xFF] |
                                                             ...
                                                             Hi3518EV300 = [0x0, 0xF];
                                                             Format:8.0; Range of color denoise luma, related to
                                                             luminance and saturation */
    HI_U8  au8ColorNoiseStrY[ISP_AUTO_ISO_STRENGTH_NUM];  /* RW;Range:Hi3559AV100 = [0x0, 0xFF] |
                                                             Hi3519AV100 = [0x0, 0xFF] | Hi3516CV500 = [0x0, 0xFF] |
                                                             Hi3516DV300 = [0x0, 0xFF] | Hi3516AV300 = [0x0, 0xFF] |
                                                             Hi3559V200 = [0x0, 0xFF] | Hi3556V200 = [0x0, 0xFF] |
                                                             Hi3516EV200 = [0x0, 0x3F] | Hi3516EV300 = [0x0, 0x3F] |
                                                             Hi3518EV300 = [0x0, 0x3F];
                                                             Format:8.0;Format:8.0; Strength of color denoise luma */
...
typedef struct hiISP_BLACK_LEVEL_S {
    ISP_OP_TYPE_E enOpType;
    HI_U16 au16BlackLevel[ISP_BAYER_CHN_NUM]; /* RW; Range: [0x0, 0xFFF];Format:12.0;
...
typedef struct hiISP_FPN_FRAME_INFO_S {
    ...
    HI_U32              u32Offset[VI_MAX_SPLIT_NODE_NUM]; /* RW;Range:[0, 0xFFF];Format:12.0;
...
typedef struct hiISP_FPN_CALIBRATE_ATTR_S {
    ...
    HI_U32               u32FrameNum;  /* RW;Range:[1, 16];Format:5.0;Number of frames to be calibrated.
...
typedef struct hiISP_DEHAZE_ATTR_S {
    ...
    HI_U8    au8DehazeLut[DEHAZE_LUT_SIZE];
    ISP_OP_TYPE_E      enOpType;
...
typedef struct hiISP_DEPURPLESTR_AUTO_ATTR_S {
    HI_U8 au8DePurpleCrStr[ISP_EXP_RATIO_STRENGTH_NUM]; /* RW;Range: [0, 8];Format:4.0;
                                                           Correction strength of the R channel */
    HI_U8 au8DePurpleCbStr[ISP_EXP_RATIO_STRENGTH_NUM]; /* RW;Range: [0, 8];Format:4.0;
...
typedef struct hiISP_LOCAL_CAC_ATTR_S {
    HI_BOOL bEnable;             /* RW;Range: [0,1];Format:1.0; enable/disable local cac */
    ...
    HI_U16  u16RDetThr[ISP_LCAC_DET_NUM];    /* RW;Range: [0,4095];Format:12.0;Component R detection threshold */
    HI_U16  u16GDetThr[ISP_LCAC_DET_NUM];    /* RW;Range: [0,4095];Format:12.0;Component G detection threshold */
    HI_U16  u16BDetThr[ISP_LCAC_DET_NUM];    /* RW;Range: [0,4095];Format:12.0;Component B detection threshold */
    HI_U16  u16LumaDetThr[ISP_LCAC_DET_NUM]; /* RW;Range: [0,4095];Format:12.0;Component Luma detection threshold */
    HI_S16  s16CbCrRatio[ISP_LCAC_DET_NUM];  /* RW;Range: [-2048, 2047];Format:S12.0; Cb/Cr ratio threshold,
                                                Not supported in hi3559av100 and hi3519av100 */
...
typedef struct hiISP_GLOBAL_CAC_ATTR_S {
    ...
    HI_U16  u16VerCoordinate;   /* RW; Range: [0, 8191];Format: 13.0; limited Range: [0, ImageHeight - 1],
                                   Vertical coordinate of the optical center */
    HI_U16  u16HorCoordinate;   /* RW; Range: [0, 8191];Format: 13.0; limited range : [0, ImageWidth - 1],
                                   Horizontal coordinate of the optical center */
    HI_S16  s16ParamRedA;       /* RW; Range: [-256, 255];Format: 9.0;
                                   Coefficient a of the radius polynomial corresponding to channel R */
    HI_S16  s16ParamRedB;       /* RW; Range: [-256, 255];Format: 9.0;
                                   Coefficient b of the radius polynomial corresponding to channel R */
    HI_S16  s16ParamRedC;       /* RW; Range: [-256, 255];Format: 9.0;
                                   Coefficient c of the radius polynomial corresponding to channel R */
    HI_S16  s16ParamBlueA;      /* RW; Range: [-256, 255];Format: 9.0;
                                   Coefficient a of the radius polynomial corresponding to channel B */
    HI_S16  s16ParamBlueB;      /* RW; Range: [-256, 255];Format: 9.0;
                                   Coefficient b of the radius polynomial corresponding to channel B */
    HI_S16  s16ParamBlueC;      /* RW; Range: [-256, 255];Format: 9.0;
                                   Coefficient c of the radius polynomial corresponding to channel B */
    HI_U8   u8VerNormShift;     /* RW; Range: [0, 7];Format: 3.0;
    ...
    HI_U8   u8HorNormShift;     /* RW; Range: [0, 7];Format: 3.0;
                                   Normalized shift parameter in the horizontal direction */
    HI_U8   u8HorNormFactor;    /* RW; Range: [0, 31];Format: 5.0;
                                   Normalized coefficient in the horizontal direction */
    HI_U16  u16CorVarThr;       /* RW; Range: [0, 4095];Format: 12.0;
...
typedef struct hiISP_RC_ATTR_S {
    HI_BOOL bEnable;       /* RW;Range:[0, 1];Format:1.0; enable/disableridial crop;
                              Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
    POINT_S stCenterCoor;  /* RW;the coordinate of central pixel.
                              Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
    HI_U32  u32Radius;     /* RW;Range:[0, 11586];Format:14.0; when the distance to central pixel is greater than
                              u32Radius, the pixel value becomes 0.
                              Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200 */
} ISP_RC_ATTR_S;

typedef struct hiISP_INNER_STATE_INFO_S {
    HI_U16 au16TextureStr[ISP_SHARPEN_GAIN_NUM]; /* RW; range: [0, 4095]; Format:7.5;Undirectional sharpen strength
                                                    for texture and detail enhancement */
    HI_U16 au16EdgeStr[ISP_SHARPEN_GAIN_NUM];    /* RW; range: [0, 4095]; Format:7.5;Directional sharpen strength
                                                    for edge enhancement */
    HI_U16 u16TextureFreq;         /* RW; range: [0, 4095];Format:6.6; Texture frequency adjustment. Texture and detail
                                      will be finer when it increase */
    HI_U16 u16EdgeFreq;            /* RW; range: [0, 4095];Format:6.6; Edge frequency adjustment. Edge will be narrower
                                      and thiner when it increase */
    HI_U8  u8OverShoot;            /* RW; range: [0, 127]; Format:7.0;u8OvershootAmt */
    HI_U8  u8UnderShoot;           /* RW; range: [0, 127]; Format:7.0;u8UndershootAmt */
    HI_U8  u8ShootSupStr;          /* RW; range: [0, 255]; Format:8.0;overshoot and undershoot suppression strength,
                                      the amplitude and width of shoot will be decrease when shootSupSt increase */

    HI_U8   u8NrLscRatio;                       /* RW;Range:[0x0, 0xff];Format:8.0; Strength of reserving the random
                                                   noise according to luma,
                                                   Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 not support */
    HI_U16  au16CoarseStr[ISP_BAYER_CHN_NUM];   /* RW;Range:[0x0, 0x3ff];Format:10.0;
                                                   Coarse Strength of noise reduction */
    HI_U8   au8WDRFrameStr[WDR_MAX_FRAME_NUM];  /* RW;Range:[0x0, 0x50];Format:7.0;
                                                   Coarse strength of each frame in wdr mode */
    HI_U8   au8ChromaStr[ISP_BAYER_CHN_NUM];    /* RW;Range:[0x0, 0x3];Format:2.0;Strength of Chrmoa noise reduction
                                                   for R/Gr/Gb/B channel, Only used for Hi3559AV100/Hi3519AV100 */
    ...
    HI_U16 u16DrcStrengthActual;    /* RW;Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] |
                                       Hi3516CV500 = [0x0, 0x3FF]| Hi3516DV300 = [0x0, 0x3FF]|
                                       ...
                                       Hi3516DV200 = [0x0, 0x3FF];Strength of dynamic range compression.
                                       Higher values lead to higher differential gain between shadows and highlights */
    HI_U32 u32WDRExpRatioActual[WDR_MAX_FRAME_NUM - 1]; /* RW; Range:[0x40, 0x4000]; Format:26.6; 0x40 means 1 times.
    ...
    HI_U16 au16BLActual[ISP_BAYER_CHN_NUM]; /* RW; Range: [0x0, 0xFFF];Format:12.0;
                                               Actual Black level values that correspond to the black levels of the
                                               R,Gr, Gb, and B components respectively. */
...
typedef struct hiISP_AE_HIST_CONFIG_S {
    ...
    ISP_AE_HIST_SKIP_E enHistSkipY;    /* RW; Range:[0, 6]; Format:4.0;
                                          ...
                                          6+=every 9th pixel */
    ISP_AE_HIST_OFFSET_X_E enHistOffsetX;  /* RW; Range:[0, 1]; Format:1.0;
                                              0= start from the first column; 1=start from second column */
    ISP_AE_HIST_OFFSET_Y_E enHistOffsetY;  /* RW; Range:[0, 1]; Format:1.0;
...
typedef struct hiISP_AE_CROP_S {
    ...
    HI_U16  u16X;    /* RW; Range: Hi3559AV100 = [0, 8192 - 256]|Hi3519AV100 = [0, 8192 - 256]|
    ...
    HI_U16  u16Y;   /* RW; Range: Hi3559AV100 = [0, 8192 - 120]|Hi3519AV100 = [0, 8192 - 120]|
    ...
    HI_U16  u16W;   /* RW; Range: Hi3559AV100 = [256, 8192]|Hi3519AV100 = [256, 8192]|Hi3516CV500 = [256, 4608]|
    ...
    HI_U16  u16H;   /* RW; Range: Hi3559AV100 = [120, 8192]|Hi3519AV100 = [120, 8192]|Hi3516CV500 = [120, 4608]|
...
typedef struct hiISP_AE_STATISTICS_CFG_S {
    ISP_AE_SWITCH_E          enAESwitch;      /* RW; Range:[0, 2]; Format:2.0;
                                                 The position of AE histogram in ISP BE pipeline */
...
#define TUNNEL_CLASS_MAX   2
typedef struct hiISP_TUNNEL_ROI_S {
    HI_BOOL  bEnable;
    HI_BOOL  bAvailable;
    HI_U32   u32TunnelAreaRatio;
    HI_U32   u32TunnelExpPerf;
} ISP_TUNNEL_ROI_S;

typedef struct hiISP_SMART_INFO_S {
    ISP_PEOPLE_ROI_S  stPeopleROI[PEOPLE_CLASS_MAX];
    ISP_TUNNEL_ROI_S  stTunnelROI[TUNNEL_CLASS_MAX];
} ISP_SMART_INFO_S;

typedef enum hiISP_AE_PEOPLE_TYPE_E {
    ISP_FACE_INDEX = 0,
    ISP_PEOPLE_INDEX = 1,
    ISP_PEOPLE_BUTT
} ISP_PEOPLE_TYPE_E;

typedef enum hiISP_AE_TUNNEL_TYPE_E {
    ISP_TUNNEL_IN_INDEX = 0,
    ISP_TUNNEL_OUT_INDEX = 1,
    ISP_TUNNEL_BUTT
} ISP_TUNNEL_TYPE_E;
...
typedef struct hiISP_AF_CROP_S {
    ...
    HI_U16  u16X;    /* RW; Range: Hi3559AV100 = [0, 7936]|Hi3519AV100 = [0, 7936]|Hi3516CV500 = [0, 4352]|
    ...
    HI_U16  u16Y;    /* RW; Range: Hi3559AV100 = [0, 8072]|Hi3519AV100 = [0, 8072]|Hi3516CV500 = [0, 4488]|
...
typedef struct hiISP_AF_RAW_CFG_S {
    ...
    HI_U8               GammaValue;     /* RW; Range: Hi3559AV100 = [0x0, 0x6] | Hi3519AV100 = [0x0, 0x6] |
                                           Hi3516CV500 = [0x0, 0x6] | Hi3516DV300 = [0x0, 0x6]|
                                           Hi3516AV300 = [0x0, 0x6] | Hi3559V200 = [0x0, 0x6]|
                                           Hi3556V200  = [0x0, 0x6]| Hi3516EV200 = [0x0, 0x1]|
                                           Hi3516EV300 = [0x0, 0x1]| Hi3518EV300 = [0x0, 0x1]|
                                           Hi3516DV200 = [0x0, 0x1]; */
...
typedef struct hiISP_AF_CFG_S {
    ...
    HI_U16                  u16Hsize;       /* RW; Range: Hi3559AV100 = [256, 8192]|Hi3519AV100 = [256, 8192]|
                                               ...
                                               Hi3516EV300 = [256,3072]|Hi3518EV300 = [256,3072]|
                                               Hi3516DV200 = [256,3072];
                                               limited Range: [256, ImageWidth],AF image width. */
    HI_U16                  u16Vsize;       /* RW; Range: Hi3559AV100 = [120, 8192]|Hi3519AV100 = [120, 8192]|
                                               ...
                                               Hi3516EV300 = [120,3072]|Hi3518EV300 = [120,3072]|
                                               Hi3516DV200 = [120,3072];
...
typedef union hiISP_STATISTICS_CTRL_U {
    ...
    struct {
        ...
        HI_U64  bit1FEAeStiGloStat  : 1;   /* [2] .Only used for Hi3559AV100/Hi3519AV100 */
        HI_U64  bit1FEAeStiLocStat  : 1;   /* [3] .Only used for Hi3559AV100/Hi3519AV100 */
        HI_U64  bit1BEAeGloStat     : 1;   /* [4] */
        HI_U64  bit1BEAeLocStat     : 1;   /* [5] */
        HI_U64  bit1BEAeStiGloStat  : 1;   /* [6] .Only used for Hi3559AV100/Hi3519AV100 */
        HI_U64  bit1BEAeStiLocStat  : 1;   /* [7] .Only used for Hi3559AV100/Hi3519AV100 */
        HI_U64  bit1AwbStat1        : 1;   /* [8] */
        HI_U64  bit1AwbStat2        : 1;   /* [9] */
        HI_U64  bit2Rsv0            : 2;   /* [10:11] */
        HI_U64  bit1FEAfStat        : 1;   /* [12] .Only used for Hi3559AV100/Hi3519AV100 */
...
typedef struct hiISP_AE_STATISTICS_S {
    HI_U32 au32FEHist1024Value[ISP_CHN_MAX_NUM][HIST_NUM];      /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0;
                                                                   Global 1024 bins histogram of FE */
    HI_U16 au16FEGlobalAvg[ISP_CHN_MAX_NUM][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
                                                                   Global average value of FE,
                                                         Not support Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U16 au16FEZoneAvg[ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF];
                                                                                              Format:16.0;
                                                                                              Zone average value of FE,
                                Not support for Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3559V200/Hi3556V200's Fe1 and Fe3,
                                Not support Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200 */
    HI_U32 au32BEHist1024Value[HIST_NUM];       /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0;
    ...
    HI_U16 au16BEZoneAvg[AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
...
typedef struct hiISP_AE_STITCH_STATISTICS_S {
    ...
    HI_U16 au16FEGlobalAvg[ISP_CHN_MAX_NUM][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
                                                                   Global average value of FE */
    HI_U16 au16FEZoneAvg[VI_MAX_PIPE_NUM][ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R;
                                                                                      Range: [0x0, 0xFFFF]; Format:16.0;
                                                                                      Zone average value of FE */
    HI_U32 au32BEHist1024Value[HIST_NUM];      /* R; Range: [0x0, 0xFFFFFFFF]; Format:32.0;
                                                  Global 1024 bins histogram of BE */
    HI_U16 au16BEGlobalAvg[BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of BE */
    HI_U16 au16BEZoneAvg[VI_MAX_PIPE_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFFFF];
                                                                                              Format:16.0;
                                                                                            Zone average value of BE */
} ISP_AE_STITCH_STATISTICS_S;

typedef struct hiISP_MG_STATISTICS_S {
    HI_U16 au16ZoneAvg[MG_ZONE_ROW][MG_ZONE_COLUMN][BAYER_PATTERN_NUM]; /* R; Range: [0x0, 0xFF]; Format:8.0;
                                                                           Zone average value */
...
typedef enum hiISP_AWB_GAIN_SWITCH_E {
    ISP_AWB_GAIN_IN_ISP = 0,
    ISP_AWB_GAIN_IN_SENSOR,
    ISP_AWB_GAIN_IN_BUTT
} ISP_AWB_GAIN_SWITCH_E;
...
typedef struct hiISP_AWB_CROP_S {
    ...
    HI_U16  u16X;  /* RW; Range: Hi3559AV100 = [0, 8192 - 60]|Hi3519AV100 = [0, 8192 - 60]|Hi3516CV500 = [0, 4608 - 60]|
                      ...
                      Hi3518EV300 = [0,3072- 60]| Hi3516DV200 = [0,3072- 60]; Format:13.0;
                      AWB image crop start x, limited range:[0, ImageWidth - u16ZoneCol * 60] */
    HI_U16  u16Y;  /* RW; Range: Hi3559AV100 = [0, 8192 - 14]|Hi3519AV100 = [0, 8192 - 14]|Hi3516CV500 = [0, 4608 - 14]|
                      ...
                      Hi3518EV300 = [0,3072-14]| Hi3516DV200 = [0,3072-14]; Format:13.0;
                      AWB image crop start y,limited range:[0, ImageHeight - u16ZoneRow * 14] */
    HI_U16  u16W;  /* RW; Range: Hi3559AV100 = [60, 8192]|Hi3519AV100 = [60, 8192]|Hi3516CV500 = [60, 4608]|
                      ...
                      Hi3516DV200 = [60,3072]; Format:14.0;AWB image crop width,
                      limited range:[u16ZoneCol * 60, ImageWidth] */
    HI_U16  u16H;  /* RW; Range: Hi3559AV100 = [14, 8192]|Hi3519AV100 = [14, 8192]|Hi3516CV500 = [14, 4608]|
                      ...
                      Hi3516DV200 = [14,3072]; Format:14.0;AWB image crop height,
                      limited range:[u16ZoneRow * 14, ImageHeight] */
} ISP_AWB_CROP_S;
...
typedef struct hiISP_WB_STATISTICS_CFG_S {
    ...
    HI_U16 u16ZoneBin;            /* RW; Range:Hi3559AV100 = [1, 4] | Hi3519AV100 = [1, 4] | Hi3516CV500 = [1, 1]|
                                     Hi3516DV300 = [1, 1]| Hi3516AV300 = [1, 1]|Hi3559V200 = [1, 1]|
                                     Hi3556V200 = [1, 1]| Hi3516EV200 = [1,1]|Hi3516EV300 = [1,1]|Hi3518EV300 = [1,1]|
                                     Hi3516DV200 = [1,1]; Brightness Bins */
    HI_U16 au16HistBinThresh[AWB_ZONE_BIN_MAX]; /* RW; Range: [0x0, 0xFFFF]; Bin Threshold */
    HI_U16 u16WhiteLevel;        /* RW; Range: [0x0, 0xFFFF];Upper limit of valid data for white region,
                                    for Bayer statistics, [0x0, 0x3FF] for RGB statistics */
    HI_U16 u16BlackLevel;        /* RW; Range: [0x0, 0xFFFF];limited range: [0x0, u16WhiteLevel],
    ...
    HI_U16 u16CbMin;             /* RW; Range: [0x0, 0xFFF];limited range: [0x0, u16CbMax]
                                    Minimum value of B/G for white region */
    HI_U16 u16CrMax;             /* RW; Range: [0x0, 0xFFF];Maximum value of R/G for white region */
    HI_U16 u16CrMin;             /* RW; Range: [0x0, 0xFFF];limited range: [0x0, u16CrMax],
...
typedef struct hiISP_WB_STITCH_STATISTICS_S {
    HI_U16  u16ZoneRow;                         /* R; Range: [0x1, 0x20];
                                                   effective horizontal block number for AWB statistic stitch window */
    HI_U16  u16ZoneCol;                         /* R; Range: [0x1, 0x100];
    ...
    HI_U16  au16ZoneCountAll[AWB_ZONE_STITCH_MAX]; /* R; Range: [0x0, 0xFFFF];
...
typedef struct hiISP_AF_STATISTICS_S {
    ISP_FE_FOCUS_STATISTICS_S stFEAFStat; /* only used for Hi3559AV100/Hi3519AV100 */
    ISP_BE_FOCUS_STATISTICS_S stBEAFStat;
    ISP_FOCUS_GRID_INFO_S     stFEAFGridInfo; /* only used for Hi3559AV100/Hi3519AV100 */
...
typedef struct hiISP_I2C_DATA_S {
    HI_BOOL bUpdate;            /* RW; Range: [0x0, 0x1]; Format:1.0;
...
typedef struct hiISP_SNS_REGS_INFO_S {
    ...
    HI_U32  u32RegNum;              /* RW;Number of registers required when exposure results are written to the sensor.
                                       The member value cannot be dynamically changed */
    HI_U8   u8Cfg2ValidDelayMax;    /* RW;Maximum number of delayed frames from the time when all sensor registers are
...
typedef struct hiISP_DCIRIS_ATTR_S {
    HI_S32 s32Kp;           /* RW; Range:[0, 100000]; Format:32.0; the proportional gain of PID algorithm,
                               default value is 7000 */
    HI_S32 s32Ki;           /* RW; Range:[0, 1000]; Format:32.0; the integral gain of PID algorithm,
                               default value is 100 */
    HI_S32 s32Kd;           /* RW; Range:[0, 100000]; Format:32.0; the derivative gain of PID algorithm,
...
typedef struct hiISP_PIRIS_ATTR_S {
    ...
    HI_BOOL bZeroIsMax;             /* RW; Range:[0, 1]; Format:1.0; Step 0 corresponds to max aperture or not,
                                       it's related to the specific iris */
    HI_U16 u16TotalStep;            /* RW; Range:[1, 1024]; Format:16.0; Total steps of  Piris's aperture,
                                       it's related to the specific iris */
    HI_U16 u16StepCount;            /* RW; Range:[1, 1024]; Format:16.0; Used steps of Piris's aperture.
    ...
    HI_U16 au16StepFNOTable[AI_MAX_STEP_FNO_NUM];   /* RW; Range:[1, 1024]; Format:16.0; Step-F number mapping table.
                                                       F1.0 is expressed as 1024, F32 is expressed as 1,
                                                       it's related to the specific iris */
    ISP_IRIS_F_NO_E  enMaxIrisFNOTarget;  /* RW; Range:[0, 10]; Format:4.0;
                                             Max F number of Piris's aperture, it's related to the specific iris */
    ISP_IRIS_F_NO_E  enMinIrisFNOTarget;  /* RW; Range:[0, 10]; Format:4.0;
...
typedef struct hiISP_ANTIFLICKER_S {
    HI_BOOL bEnable;     /* RW; Range:[0, 1]; Format:1.0; */
    HI_U8   u8Frequency; /* RW; Range:[0, 255]; Format:8.0;
...
typedef struct hiISP_SUBFLICKER_S {
    ...
    HI_U8   u8LumaDiff; /* RW; Range:[0, 100]; Format:8.0; if subflicker mode enable, current luma is less than AE
...
typedef enum hiISP_FSWDR_MODE_E {
    ...
    ISP_FSWDR_AUTO_LONG_FRAME_MODE = 0x2, /* Auto long frame mode, only effective in LINE_WDR,  When running in this
...
typedef struct hiISP_AE_ATTR_S {
    /* base parameter */
    ISP_AE_RANGE_S stExpTimeRange;   /* RW; Range:[0x0, 0xFFFFFFFF]; Format:32.0; sensor exposure time (unit: us),
                                        it's related to the specific sensor */
    ISP_AE_RANGE_S stAGainRange;     /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
                                        sensor analog gain (unit: times, 10bit precision), it's related to the
                                        specific sensor */
    ISP_AE_RANGE_S stDGainRange;     /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
                                        sensor digital gain (unit: times, 10bit precision), it's related to the
                                        specific sensor */
    ISP_AE_RANGE_S stISPDGainRange;  /* RW; Range:[0x400, 0x40000]; Format:22.10;
                                        ISP digital gain (unit: times, 10bit precision), it's related to the
                                        ISP digital gain range */
    ISP_AE_RANGE_S stSysGainRange;   /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
                                        system gain (unit: times, 10bit precision), it's related to the specific
                                        sensor and ISP Dgain range */
    HI_U32 u32GainThreshold;         /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
                                        Gain threshold for slow shutter mode (unit: times, 10bit precision) */

    HI_U8  u8Speed;                  /* RW; Range:[0x0, 0xFF]; Format:8.0;
                                        AE adjust step for dark scene to bright scene switch */
    HI_U16  u16BlackSpeedBias;       /* RW; Range:[0x0, 0xFFFF]; Format:16.0;
    ...
    HI_BOOL bWDRQuick;               /* RW; Range:[0, 1]; Format:1.0; WDR use delay strategy or not;
                                        If is true, WDR AE adjust will be faster */

    HI_U16  u16ISOCalCoef;     /* RW; Range:[0x0, 0xFFFF]; Format:8.8;
...
typedef struct hiISP_ME_ATTR_S {
    ...
    HI_U32 u32ExpTime;  /* RW; Range:[0x0, 0xFFFFFFFF]; Format:32.0;
                           sensor exposure time (unit: us), it's related to the specific sensor */
    HI_U32 u32AGain;    /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
                           sensor analog gain (unit: times, 10bit precision), it's related to the specific sensor */
    HI_U32 u32DGain;    /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
    ...
    HI_U32 u32ISPDGain; /* RW; Range:[0x400, 0x40000]; Format:22.10; ISP digital gain (unit: times, 10bit precision),
                           it's related to the ISP digital gain range */
} ISP_ME_ATTR_S;
...
typedef struct hiISP_EXPOSURE_ATTR_S {
    ...
    HI_BOOL   bHistStatAdjust;  /* RW; Range:[0, 1]; Format:1.0;
                                   HI_TRUE: 256 bin histogram statistic config will adjust
                                   when large red or blue area detected.
    ...
    HI_BOOL   bAdvanceAE;     /* RW; Range:[0, 1]; Format:1.0; open advance AE or not */
} ISP_EXPOSURE_ATTR_S;

#define ISP_AE_ROUTE_MAX_NODES                    16
typedef struct hiISP_AE_ROUTE_NODE_S {
    HI_U32  u32IntTime;          /* RW; Range:(0x0, 0xFFFFFFFF]; Format:32.0;
                                    sensor exposure time (unit: us), it's related to the specific sensor */
    HI_U32  u32SysGain;          /* RW; Range:[0x400, 0xFFFFFFFF]; Format:22.10;
                                    system gain (unit: times, 10bit precision), it's related to the specific sensor and
                                    ISP Dgain range */
    ISP_IRIS_F_NO_E  enIrisFNO;  /* RW; Range:[0, 10]; Format:4.0;
                                    the F number of the iris's aperture, only support for Piris */
    HI_U32  u32IrisFNOLin;       /* RW; Range:[0x1, 0x400]; Format:32.0;
...
typedef struct hiISP_AE_ROUTE_EX_NODE_S {
    HI_U32  u32IntTime;   /* RW; Range:(0x0, 0xFFFFFFFF]; Format:32.0;
                             sensor exposure time (unit: us), it's related to the specific sensor */
    HI_U32  u32Again;     /* RW; Range:[0x400, 0x3FFFFF]; Format:22.10;
                             sensor analog gain (unit: times, 10bit precision), it's related to the specific sensor */
    HI_U32  u32Dgain;     /* RW; Range:[0x400, 0x3FFFFF]; Format:22.10;
                             sensor digital gain (unit: times, 10bit precision), it's related to the specific sensor */
    HI_U32  u32IspDgain;    /* RW; Range:[0x400, 0x40000]; Format:22.10;
...
typedef struct hiISP_EXP_INFO_S {
    ...
    HI_U32 u32Exposure;                /* R; Range:[0x0, 0xFFFFFFFF]; Format:32.0; */
    HI_BOOL bExposureIsMAX;            /* R; Range:[0, 1]; Format:1.0; */
    HI_S16 s16HistError;               /* R; Range:[-32768, 32767]; Format:16.0; */
    HI_U32 au32AE_Hist1024Value[HIST_NUM]; /* R; Range:[0x0, 0xFFFFFFFF]; Format:32.0;
    ...
    HI_U16 u16WdrExpCoef;           /* R; Range:[0x0, 0x400]; Format:6.10; 0x400 means 1 times */
    HI_U32 u32FirstStableTime;      /* R; Range:[0x0, 0xFFFFFFFF]; Format:32.0; AE first stable time for quick start */
    HI_U32 u32QuickStarISO;         /* R; Range:[0x64, 0xFFFFFFFF]; Format:32.0; */
...
typedef struct {
    HI_U32 u32TarFps;
    HI_U32 u32TarIspDgain; /* 10bit */
    ISP_EXP_PARAM_REG stTimeReg[10]; /* 10 */
    ISP_EXP_PARAM_REG stAgainReg[10]; /* 10 */
    ISP_EXP_PARAM_REG stDgainReg[10]; /* 10 */
} ISP_EXP_CONVERT_PARAM;

#define EXP_RATIO_NUM                             3
typedef struct hiISP_WDR_EXPOSURE_ATTR_S {
    ISP_OP_TYPE_E enExpRatioType;   /* RW; Range:[0, 1]; Format:1.0;
    ...
    HI_U32 u32ExpRatioMax;  /* RW; Range:[0x40, 0x4000]; Format:26.6; 0x40 means 1 times.
                               When enExpRatioType is OP_TYPE_AUTO, u32ExpRatioMax is max(upper limit) of ExpRatio
                               generated by firmware.
                               When enExpRatioType is OP_TYPE_MANUAL, u32ExpRatioMax is invalid. */
    HI_U32 u32ExpRatioMin;  /* RW; Range:[0x40, 0x4000]; Format:26.6; limited Range:[0x40, u32ExpRatioMax],
                               0x40 means 1 times.
                               When enExpRatioType is OP_TYPE_AUTO, u32ExpRatioMin is min(lower limit) of ExpRatio
                               generated by firmware.
                               When enExpRatioType is OP_TYPE_MANUAL, u32ExpRatioMin is invalid. */
    HI_U16 u16Tolerance;    /* RW; Range:[0x0, 0xFF]; Format:8.0;et the dynamic range tolerance.
    ...
    HI_U16 u16HighLightTarget;  /* RW; Range:[0x0, 0x400]; Format:10.0; the high light target. */
    HI_U16 u16ExpCoefMin;     /* RW; Range:[0x0, 0x400]; Format:16.0; min exposure cofficient */
} ISP_WDR_EXPOSURE_ATTR_S;

typedef struct hiISP_HDR_EXPOSURE_ATTR_S {
    ISP_OP_TYPE_E enExpHDRLvType; /* RW; Range:[0, 1]; Format:1.0;
    ...
    HI_U32 u32ExpHDRLvMin;        /* RW; Range:[0x40, 0x400]; Format:26.6; limited range:[0x40, u32ExpHDRLvMax],
                                     0x40 means 1 times.
...
typedef struct hiISP_SMART_EXPOSURE_ATTR_S {
    ...
    ISP_OP_TYPE_E enSmartExpType; /* RW; Range:[0, 1]; Format:1.0;
...
typedef struct hiISP_AWB_CT_LIMIT_ATTR_S {
    ...
    HI_U16 u16HighRgLimit; /* RW; Range:[0x0, 0xFFF]; Format:4.8;
                              in Manual Mode, user define the Max Rgain of High Color Temperature */
    HI_U16 u16HighBgLimit; /* RW; Range:[0x0, 0xFFF]; Format:4.8;
                              in Manual Mode, user define the Min Bgain of High Color Temperature */
    HI_U16 u16LowRgLimit;  /* RW; Range:[0x0, 0xFFF]; Format:4.8; limited range:[0x0, u16HighRgLimit),
                              in Manual Mode, user define the Min Rgain of Low Color Temperature */
    HI_U16 u16LowBgLimit;  /* RW; Range:[0, 0xFFF]; Format:4.8; limited Range:(u16HighBgLimit, 0xFFF],
...
typedef struct hiISP_AWB_IN_OUT_ATTR_S {
    ...
    HI_U16 u16LowStop;       /* RW;Format:16.0;limited range:(0, u16LowStart),
                                4500K is recommend, should be smaller than u8LowStart */
    HI_U16 u16HighStart;     /* RW;Format:16.0;limited range:(u16LowStart, 0xFFFF],
                                6500K is recommend, shoule be larger than u8LowStart */
    HI_U16 u16HighStop;      /* RW;Format:16.0;limited range:(u16HighStart, 0xFFFF],
                                8000K is recommend, should be larger than u8HighStart */
    HI_BOOL bGreenEnhanceEn; /* RW; Range:[0, 1]; Format:1.0;
                                If this is enabled, Green channel will be enhanced based on the ratio of green plant */
...
typedef struct hiISP_AWB_LUM_HISTGRAM_ATTR_S {
    ...
    HI_U8   au8HistThresh[AWB_LUM_HIST_NUM];  /* RW; Range:[0x0, 0xFF]; Format:8.0;
                                                 In manual mode, user define luma thresh, thresh[0] is 0,
                                                 thresh[5] is 0xFF,  thresh[i] greater or equal to  thresh[i-1] */
    HI_U16  au16HistWt[AWB_LUM_HIST_NUM];     /* RW; Range:[0x0, 0xFFFF]; Format:16.0;
...
typedef struct hiISP_AWB_ATTR_EX_S {
    ...
    HI_U16 u16CurveLLimit;   /* RW; Range:[0x0, 0x100]; Format:9.0; Left limit of AWB Curve,
                                recomend for indoor 0xE0, outdoor 0xE0 */
    HI_U16 u16CurveRLimit;   /* RW; Range:[0x100, 0xFFF]; Format:12.0; Right Limit of AWB Curve,
    ...
    HI_BOOL bMultiLightSourceEn;              /* RW; Range:[0, 1]; Format:1.0; If enabled, awb will do special process
                                                 in multi light source enviroment */
    ISP_AWB_MULTI_LS_TYPE_E enMultiLSType;    /* Saturation or CCM Tunning */
    HI_U16  u16MultiLSScaler;                 /* RW; Range:[0x0, 0x100]; Format:12.0;
                                                 In saturation type, it means the max saturation it can achieve,
                                                 in ccm type, it means the strenght of multi process. */
    HI_U16  au16MultiCTBin[AWB_MULTI_CT_NUM]; /* RW; Range:[0, 0XFFFF]; Format:16.0;
                                                 AWB Support divide the color temperature range by 8 bins */
    HI_U16  au16MultiCTWt[AWB_MULTI_CT_NUM];  /* RW; Range:[0x0, 0x400];Weight for different color temperature,
    ...
    HI_U8   u8FineTunStrength;  /* RW; Range:[0x0, 0xFF]; Format:8.0;
...
typedef struct hiISP_AWB_ATTR_S {
    HI_BOOL bEnable;               /* RW; Range:[0x0, 0x1]; Format:1.0;If AWB is disabled, static wb gain will be used,
    ...
    HI_S32 as32CurvePara[AWB_CURVE_PARA_NUM]; /* RW; Format:32.0;Calibration Information,
    ...
    HI_U16 u16ZoneSel;       /* RW; Range: [0, 255]; Format:8.0; A value of 0 or 0xFF means global AWB,
    ...
    HI_U16 u16LowColorTemp;  /* RW; Range: [0, 65535]; Format:16.0; Limited Range:[0, u16HighColorTemp),
                                AWB min temperature, Recommended: [2000, 2500] */
    ISP_AWB_CT_LIMIT_ATTR_S stCTLimit;
    HI_BOOL bShiftLimitEn;  /* RW; Range: [0, 1]; Format:1.0; If enabled, when the statistic information is out of
    ...
    HI_BOOL bNaturalCastEn; /* RW, Range: [0, 1]; Format:1.0; if enabled, the color performance will be natural in
...
typedef struct  hiISP_SPECAWB_FACTTBL_ELEMENT_S {
    ...
    HI_U8     u8FactTbl[SPECAWB_FACTTBL_SIZE][SPECAWB_FACTTBL_SIZE]; /* RW;Range:[0, 0xFF];
                                                                        Weight for light source detection. */
} ISP_SPECAWB_FACTTBL_ELEMENT_S;

typedef struct  hiISP_SPECAWB_ATTR_S {
    ISP_SPECKCWB_S    stWBCenter;        /* RW;WB gain value at the center of the table: The table index is
                                            calculated as a relative value from this gain. */
    ...
    ISP_SPECKCWB_S    stLogFact;         /* RW;Range covered by the table: 1/exp(stLogFact) to exp(stLogFact).
                                            For example, if it is 1.0, WBDelta will be 1/e to e.
                                            However, e = 2.71828 ... (base of natural logarithm) */
    HI_S32            s32LimitFactMin;   /* RW;Range:[0, s32LimitFactMax];AWB statics threshold value:
                                            minimum threshold value of ratio to pixel maximum value. */
    HI_S32            s32LimitFactMax;   /* RW;Range:[s32LimitFactMin, 0xFFFF];AWB statics threshold value:
                                            maximum threshold value of ratio to pixel maximum value. */
    HI_S32            s32LimitFactLimit; /* RW;Range:[0x600, 0x4000]; AWB statics limit value:
                                            ratio to (pixel maximum value * s32LimitFactMax) */
    HI_S32            s32FactOffset;     /* RW;Range:[0, 0x800];
                                            The offset value of the weight when calculating the AWB statics */
    HI_S32            s32BFact;          /* RW;Range:[0x399, 0x500];
                                            The value of specular weight when calculating the AWB statics */
    HI_S32            s32ACntMin;        /* RW;Range:[0, 0x20];Threshold for block adoption.
    ...
    HI_U8             bLastIsFlash;      /* RW;Range:[1]: The last table is used for flash.
                                            0: Used for unknown Bv value. */
    HI_S16            s16BvFlashELimit;  /* RW;Range:[-32768, 32767];Threshold of Bv value before strobe lighting when
    ...
    ISP_SPECKCWBS16_S stWBCnvTbl[SPECAWB_FACTTBL_SIZE][SPECAWB_FACTTBL_SIZE]; /* RW; WB gain conversion table
...
typedef struct hiISP_SPECAWB_CONTROL_ATTR_S {
    ...
    HI_S16 s16BlendLowBvThresh;         /* RW; Range: [-32768, s16BlendHighBvThresh);
...
typedef struct hiISP_COLORMATRIX_MANUAL_S {
    HI_BOOL bSatEn;                  /* RW; Range: [0, 1]; Format:1.0;
...
typedef struct hiISP_COLORMATRIX_PARAM_S {
    ...
    HI_U16 au16CCM[CCM_MATRIX_SIZE]; /* RW; Range: [0x0, 0xFFFF]; Format:8.8; CCM matrixes for different
                                        color temperature */
...
typedef struct hiISP_COLORMATRIX_AUTO_S {
    ...
    HI_BOOL bTempActEn;   /* RW; Range: [0, 1]; Format:1.0; if enabled, CCM will bypass when color temperature is
...
typedef struct hiISP_WB_INFO_S {
    ...
    HI_U16 u16ColorTemp;            /* R; Range: [0x0, 0xFFFF];Format:16.0;Detect color temperature, maybe out of color
                                       cemeprature range */
    ...
    HI_U8  u8MultiDegree;       /* R; Range: [0x0, 0xFF];0 means uniform light source, larger value means multi
                                   light source */
...
typedef struct hiISP_QUICK_START_PARAM_S {
    HI_BOOL bQuickStartEn;
    HI_U8 u8BlackFrameNum;
    HI_BOOL bIrModeEn;
    HI_U32 u32InitExposureIr;
    HI_U32 u32ISOThrIr;
    HI_U16 u16IrCutDelayTime;
} ISP_QUICK_START_PARAM_S;
...
typedef struct hiDNG_RAW_FORMAT_S {
    ...
    HI_U8 au8CfaPlaneColor[CFACOLORPLANE];        /* RO;Format:8.0; Indicate the planer numbers of raw data;
    ...
    DNG_DEFAULTSCALE_S stDefaultScale;            /* Specifies the default scale factors for each direction to convert
                                                     the image to square pixels */
    DNG_REPEATPATTERNDIM_S stCfaRepeatPatternDim; /* Specifies the pixel number of repeat color planer in each
                                                     direction */
    HI_U8 au8CfaPattern[ISP_BAYER_CHN];           /* RO;Format:8.0; Indicate the bayer start order;
                                                     0:red 1:green 2: blue */
} DNG_RAW_FORMAT_S;
...
typedef struct hiDNG_IMAGE_STATIC_INFO_S {
    ...
    DNG_SRATIONAL_S astColorMatrix1[CCM_MATRIX_SIZE];       /* defines a transformation matrix that converts XYZ values
                                                               to reference camera native color space values,
                                                               under the first calibration illuminant. */
    DNG_SRATIONAL_S astColorMatrix2[CCM_MATRIX_SIZE];       /* defines a transformation matrix that converts XYZ values
                                                               to reference camera native color space values,
                                                               under the second calibration illuminant. */
    DNG_SRATIONAL_S astCameraCalibration1[CCM_MATRIX_SIZE]; /* defines a calibration matrix that transforms reference
                                                               camera native space values to individual camera native
                                                               space values under the first calibration illuminant */
    DNG_SRATIONAL_S astCameraCalibration2[CCM_MATRIX_SIZE]; /* defines a calibration matrix that transforms reference
                                                               camera native space values to individual camera native
                                                               space values under the second calibration illuminant */
    DNG_SRATIONAL_S astForwadMatrix1[CCM_MATRIX_SIZE];      /* defines a matrix that maps white balanced camera colors
                                                               to XYZ D50 colors */
    DNG_SRATIONAL_S astForwadMatrix2[CCM_MATRIX_SIZE];      /* defines a matrix that maps white balanced camera colors
                                                               to XYZ D50 colors */

    HI_U8  u8CalibrationIlluminant1; /* RO;Format:8.0;Light source, actually this means white balance setting.
    ...
    HI_U8  u8CalibrationIlluminant2; /* RO;Format:8.0;Light source, actually this means white balance setting.
                                        '0' means unknown, '1' daylight, '2' fluorescent, '3' tungsten, '10' flash,
                                        '17' standard light A, '18' standard light B, '19' standard light C,
                                        '20' D55, '21' D65, '22' D75, '255' other */
...
/* Only used for Hi3516CV500/Hi3516DV300 */
typedef enum hiISP_CALCFLICKER_TYPE_E {
    FLICKER_TYPE_NONE = 0,
    FLICKER_TYPE_UNKNOW,
    FLICKER_TYPE_50HZ,
    FLICKER_TYPE_60HZ,
    FLICKER_TYPE_BUTT,
} ISP_CALCFLICKER_TYPE_E;

/* Only used for Hi3516CV500/Hi3516DV300 */
typedef struct hiISP_CALCFLICKER_INPUT_S {
    HI_U32 u32LinesPerSecond;      /* The total line number of 1 second */
} ISP_CALCFLICKER_INPUT_S;

/* Only used for Hi3516CV500/Hi3516DV300 */
typedef struct hiISP_CALCFLICKER_OUTPUT_S {
    ISP_CALCFLICKER_TYPE_E enFlickerType;  /* The calculate result of flicker type */
} ISP_CALCFLICKER_OUTPUT_S;
