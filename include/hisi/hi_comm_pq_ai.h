...
#define HI_ERR_PQ_AI_NULL_PTR         HI_DEF_ERR(HI_ID_PQ_AI, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define HI_ERR_PQ_AI_ILLEGAL_PARAM    HI_DEF_ERR(HI_ID_PQ_AI, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define HI_ERR_PQ_AI_NOT_SUPPORT      HI_DEF_ERR(HI_ID_PQ_AI, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
